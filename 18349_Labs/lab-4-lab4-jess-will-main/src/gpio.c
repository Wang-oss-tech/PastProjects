 ...
 *
 * This source file contains functions for initializing and controlling GPIO pins.
 * It provides functions for initialization, setting, clearing, and reading from GPIO pins.
 *
 * @date 10/29/2023
