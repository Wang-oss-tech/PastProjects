/* i2c.c: This code offers functions for interfacing with an I2C bus on a microcontroller. It provides initialization, 
  start/stop, write, and a placeholder for read operations. The code includes register mappings and configurations
  for the I2C module.
*/
...
/** @brief CCR hardcoded value*/
#define I2C_CCR_VAL  0x50 // 0xA0

/** @briefACK*/
#define I2C_ACK (1 << 10) 


/** @brief: Print string to I2C
 * 
 * 
 * @param input clock for I2C value, hardcoded later
*/
...
/** @brief: Starts I2C master, implemented by activating start bit in I2C start
 * 
 */
