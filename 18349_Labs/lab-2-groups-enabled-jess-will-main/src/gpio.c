/* gpio.c: This code offers functions to manage GPIO pins on a microcontroller. It provides initialization, configuration, 
    and interaction functions to set pin states, modes, and characteristics. The code is designed for microcontrollers with
     GPIO ports labeled A through G.*/
