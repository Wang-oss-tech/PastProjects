/**
 * @file uart_polling.c
 * @brief UART polling mode functions for data transmission and reception
 * 
 * This file contains functions to initialize and operate the UART module
 * in polling mode. It provides functions for initializing UART with specified
 * baud rate, transmitting and receiving bytes, and sending strings over UART.
 * 
 * @date 10/29/2023
