 ...
 * @file gpio.h
 *
 * @brief GPIO Control Function Prototypes
 *
 * This header file declares function prototypes for initializing and controlling
 * GPIO pins. It provides functions for setting, clearing, and reading from GPIO pins.
 *
 * @date 10/29/2023
