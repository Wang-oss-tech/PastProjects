 ...
 * @file rcc.h
 *
 * @brief Reset and Clock Control (RCC) Register Definitions
 *
 * This header file defines the register map for the RCC module, which
 * controls system reset and clock configuration.
 *
 * @date 10/29/2023
